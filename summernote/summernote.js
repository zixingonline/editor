  ...
  */
  ...
  var Editor = /** @class */ (function () {
      function Editor(context) {
           ...
           * download-自定义按钮事件
           */ 
          this.download = this.wrapCommand(function () {
              if (this.isEmpty()) {
                return;
              }

              var isActivated = this.context.invoke('codeview.isActivated');
              this.context.invoke('codeview.sync');
              var htmlCode = isActivated ? this.context.layoutInfo.codable.val() : this.context.layoutInfo.editable.html();
              ...
              linkNode.download = "file_" + btoa(new Date().getTime()) + ".html";
  ...
  var Buttons = /** @class */ (function () {
      ...
      Buttons.prototype.addToolbarButtons = function () {
          ...
          for (var styleIdx = 0, styleLen = this.options.styleTags.length; styleIdx < styleLen; styleIdx++) {
              ...
              // 自定义toolbar功能
          this.context.memo('button.download', function () {
              return _this.button({
                  className: 'btn-diy btn-download',
                  contents: _this.ui.icon(_this.options.icons.download),
                  tooltip: _this.lang.options.download + _this.representShortcut('download'),
                  click: _this.context.createInvokeHandlerAndUpdateState('editor.download')
              }).render();
          });
  ...
  var VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              '</div>',
              '<div class="form-group note-form-group row-fluid">',
              "<label class=\"note-form-label\">" + this.lang.video.poster + "</label>",
              '<input class="note-video-poster-url form-control note-form-control note-input" type="text" />',
              '</div>',
          ].join('');
      ...
      VideoDialog.prototype.createVideoNode = function (url, poster) {
      ...
      VideoDialog.prototype.show = function () {
          ...
          this.context.invoke('editor.saveRange');
          this.showVideoDialog(text).then(function (url, poster) {
            console.log(url, poster);
              // [workaround] hide dialog before restore range for IE range focus
              _this.ui.hideDialog(_this.$dialog);
              _this.context.invoke('editor.restoreRange');
              // build node
              var $node = _this.createVideoNode(url, poster);
              if ($node) {
                  // insert video node
      ...
      VideoDialog.prototype.showVideoDialog = function (text) {
          ...
          return $$1.Deferred(function (deferred) {
              ...
              var $videoPoster = _this.$dialog.find('.note-video-poster-url');
              ...
              _this.ui.onDialogShown(_this.$dialog, function () {
                  ...
                  $videoBtn.click(function (event) {
                      event.preventDefault();
                      deferred.resolve($videoUrl.val(), $videoPoster.val());
                  });
  ...
  $$1.summernote = $$1.extend($$1.summernote, {
      ...
      options: {
          ...
          fontSizes: ['8', '9', '10', '11', '12', '13', '14', '16', '17', '18', '19', '20', '24', '36'],
